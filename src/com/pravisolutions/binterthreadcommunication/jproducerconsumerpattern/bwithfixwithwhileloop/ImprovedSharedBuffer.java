package com.pravisolutions.binterthreadcommunication.jproducerconsumerpattern.bwithfixwithwhileloop;

import java.util.LinkedList;
import java.util.List;

public class ImprovedSharedBuffer {

    private int capacity;
    private List<Integer> buffer;

    ImprovedSharedBuffer() {
        this.capacity = 5;
